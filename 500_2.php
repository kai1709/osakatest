...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td>For the questions below, select the most appropriate word for the parentheses 
      ...
      以下の文の（　　）に入るもっとも適当なことばを、右端の選択肢から一つ選んでください。全部の問題に答えたら、一番下の＜Next＞ボタンをクリックしてください。<br>
      画面を再読込すると違う問題が出てくるので、再読込はしないでください。<br>
    </td>
  </tr>
</table>
<br>
...
<input type=hidden name="NLEVEL" value="500">
<?php
for($i=1;$i<11;$i++){
$id="Q".$i;
...
$j=0;
$fl=fopen("test5.csv","r");
while($mdat=fgetcsv($fl,600)){
