...
<FORM onsubmit="return FormCheck(this)" action="400_2.php" method="post">
  ...
  <TABLE border="0">
    ...
    <TR> 
      <TD colspan="2"> 
        <DIV class="text"> 　　　 安全な国　　環境問題　　法律　　健康　　<BR>
          　　　選挙　　講義　　異文化経験 <br>
          　　　　　　　　　　　　　　　　　　　　　　　　　<font size="2">正解は<a href="#" onClick="MM_openBrWindow('answer1.php','Q1answer','scrollbars=yes,resizable=yes,width=500,height=350')">こちら(Answer)</a></font></DIV>
      </TD>
    </TR>
  </TABLE>  
  <br>
  ...
  <table border="0">
    <tr> 
      <td> 
        <div class="text"> Q.2　Can read the following <i>kanji</i> words.<br>
          　以下の漢字語を正しく読むことができる。<br>
          <br>
        </div>
      </td>
      <td> 
    ...
    <tr> 
      <td colspan="2"> 
        <div class="text"> 　　　輸入　　経済　　関係　　経験　　制度<br>
          　　　女性　　義務　　知識　　落とす　　遅れる <br>
          　　　　　　　　　　　　　　　　　　　　　　　　　<font size="2">正解は<a href="#" onClick="MM_openBrWindow('answer2.php','Q2answer','scrollbars=yes,resizable=yes,width=500,height=350')">こちら(Answer)</a></font></div>
      </td>
    </tr>
  </table>
  <br>
  ...
  <TABLE border="0">
    <TR> 
      <TD> 
        <DIV class="text"> Q.3　Can handle conversations with friends and conversations 
          with professors in appropriate styles. <br>
          　友人との会話と先生との会話を、それぞれ適切なスタイルで行うことができる。<br>
        </DIV>
      </TD>
      <TD> 
        <TABLE>
  ...
  <table border="0">
    <tr> 
      <td> 
        <div class="text"> Q.4 Can report your experience in Japanese in the way 
          exemplified in the following passage. <br>
          　準備をしなくても、次のような話ができる。<br>
        </div>
      </td>
      <td> 
        <table>
    ...
    <tr> 
      <td colspan="2"> 
        <div class="text"> <br>
          　仕事が終わって電車に乗っていると、卒業式が終わった学生が乗ってきました。これから卒業パーティーに行くようなようすでした。花束を持った学生もいたし、着物を着た女子学生もいました。みんなとても楽しそうでした。 
  ...
  <table border="0">
    <tr> 
      <td> 
        <div class="text"> Q.5　Can roughly understand TV news or TV commentaries 
          that deal with your topic of interest. <br>
          　自分の興味のある話題についてのテレビのニュースや解説や論説などが概ね理解できる。</div>
      </td>
      <td> 
        <table>
          <tr> 
  ...
  <table border="0">
    <tr> 
      <td> 
        <div class="text"> Q.6 Can keep extending your talk and writing while 
          making few grammatical or morphological errors.<br>
          　文法や言葉を間違えることがあるが、コミュニケーションに支障を来す ことなく 話すこと・書くことがで きる。</div>
      </td>
      <td> 
        <table>
          <tr> 
  ...
  <TABLE border="0">
    <TR> 
      <TD width="593"> 
        <DIV class="text"> Q.7 Can understand the passage given below without 
          any difficulty. <br>
          　 以下の文を困難なく理解することができる。<br>
        </DIV>
      </TD>
      <TD align="right"> 
        <TABLE>
    ...
    <TR> 
      <TD colspan="2"> 
        <DIV class="text"> <br>
          　父は医者嫌いである。子どもの時から医者にはいっさい行ったことがないらしい。<BR>
          　もちろん健康診断なども受けたことがないし、かぜを引いたりお腹が痛くなったりしても、決して医者に行くことはなく、適当なくすりですませてしまう。薬を飲んでもなかなか回復しないようなときに、母が病院に行ったらと言っても、頑として拒否するのがうちの父である。病院に行ったらむしろ病気をもらってしまうから行かないんだ、というのが父なりの病院拒否の理由であるらしい。そういう父の血を引いてか、わたしも相当の医者嫌いである。妻の目には、わたしはまったく父のように映って 
...
<TR>
<TD>
        <DIV class="text"> Q.8 Can manage to understand texts in your major/specialty 
          while consulting a dictionary. <br>
          　自分の専門分野のテキストを辞書の助けを借りながら読んで、理解することができる。<br>
          <br>
        </DIV>
</TD>
<TD>
	<TABLE>
		<TR>
			<TD class="center">
				<DIV class="ctext">1</DIV><input type="radio" name="Q8" value="1">
			</TD>
			<TD class="center">
				<DIV class="ctext">2</DIV><input type="radio" name="Q8" value="2">
			</TD>
			<TD class="center">
				<DIV class="ctext">3</DIV><input type="radio" name="Q8" value="3">
			</TD>
			<TD class="center">
				<DIV class="ctext">4</DIV><input type="radio" name="Q8" value="4">
			</TD>
			<TD class="center">
				<DIV class="ctext">5</DIV><input type="radio" name="Q8" value="5">
			</TD>
		</TR>
	</TABLE>
</TD>
  ...
  <TABLE border="0">
    ...
    <TR> 
      <TD colspan="2"> 
        <DIV class="text"> <br>
          日本語クラスの山田先生<BR>
          　日本語のクラスでは、いつもお世話になっております。<BR>
          　さて、来週の金曜日はわたしが「わたしの専門」について発表することになっていましたが、ちょっとできなくなってしまいました。<br>
          というのは、来週の金曜日にわたしの研究室に外国から２人お客さんがくることになって、先生からいっしょに案内をするようにと言われました。研究室の日本人の院生の人たちは英語を話すのがあまり得意ではないので、先生からぜひにと言われて断るわけにもいきませんでした。<br>
          　 このような事情ですので、来週の授業は、すみませんが、休ませてください。また、発表は再来週にでもさせていただければと思います。<br>
          　 ご迷惑をかけて申しわけありませんが、よろしくお願いします。<BR>
          　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　ホワイト </DIV>
      </TD>
    </TR>
  </TABLE>  
  ...
  <table border="0">
    <tr> 
      <td> 
        <div class="text"> Q.10 Can manage to write a short report that communicates 
          your observation/analysis while consulting a dictionary. <br>
          　辞書を使いながら、簡単なレポートを趣旨がきちんと伝わるように書くことができる。<br>
        </div>
      </td>
      <td> 
        <table>
